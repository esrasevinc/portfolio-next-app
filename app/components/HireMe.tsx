      ...
      <div className='lg:w-48 h-auto flex items-center justify-center relative w-28 md:w-30'>
       ...
       />
        ...
        <Link 
          ...
          target={'_blank'}
          className='flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-neutral-700 dark:bg-light dark:text-dark text-light border-2 border-solid
