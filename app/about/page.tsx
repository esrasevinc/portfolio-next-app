...
const About = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-center min-h-[80vh] justify-between px-80 w-full'>
      ...
      <motion.div className='text-gray-800 dark:text-light' initial={{y:50}} whileInView={{y:0}} transition={{duration:1.5, type:'spring'}}>
      ...
      <div className='flex flex-col mt-16 items-center'>
        <Link 
              ...
              target={'_blank'}
              className='items-center px-6 py-3 bg-purple-950 text-light dark:bg-light dark:hover:text-light dark:text-purple-900 hover:bg-purple-800 hover:text-light rounded-xl text-lg font-semibold border'
              >
                Contact Me
        </Link>
